                            ...
                            <div className="md:w-1/2">
                                ...
                                <div className="mt-10">
                                    ...
                                    <div className="flex flex-col sm:flex-row gap-4">
                                        <a href="https://apps.apple.com/co/app/inutrips/id6450268527" target="_blank" rel="noopener noreferrer" className="bg-black text-white px-6 py-3 rounded-xl flex items-center gap-3 hover:bg-gray-800 transition-all shadow-lg hover:-translate-y-1">
                                            {/* Apple Logo SVG */}
                                        ...
                                        <a href="https://play.google.com/store/apps/details?id=com.inutrips.passenger" target="_blank" rel="noopener noreferrer" className="bg-black text-white px-6 py-3 rounded-xl flex items-center gap-3 hover:bg-gray-800 transition-all shadow-lg hover:-translate-y-1">
                        ...
                        <div className="flex flex-col-reverse md:flex-row items-center gap-12 lg:gap-24">
                            ...
                            <div className="md:w-1/2">
                                ...
                                <div className="flex flex-col sm:flex-row gap-4 mt-8">
                                    <a href="https://apps.apple.com/co/app/inutrips-drive/id6748416907" target="_blank" rel="noopener noreferrer" className="bg-secondary text-white px-6 py-3 rounded-xl flex items-center gap-3 hover:bg-opacity-90 transition-all shadow-lg hover:-translate-y-1">
                                        {/* Apple Logo SVG */}
                                        <svg viewBox="0 0 384 512" className="w-6 h-6 fill-current" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M318.7 268.7c-.2-36.7 16.4-64.4 50-84.8-18.8-26.9-47.2-41.7-84.7-44.6-35.5-2.8-74.3 20.7-88.5 20.7-15 0-49.4-19.7-76.4-19.7C63.3 141.2 4 184.8 4 273.5q0 39.3 14.4 81.2c12.8 36.7 59 126.7 107.2 125.2 25.2-.6 43-17.9 75.8-17.9 31.8 0 48.3 17.9 76.4 17.9 48.6-.7 90.4-82.5 102.6-119.3-65.2-30.7-61.7-90-61.7-91.9zm-56.6-164.2c27.3-32.4 24.8-61.9 24-72.5-24.1 1.4-52 16.4-67.9 34.9-17.5 19.8-27.8 44.3-25.6 71.9 26.1 2 52.3-11.4 69.5-34.3z" />
                                        </svg>
                                    ...
                                    <a href="https://play.google.com/store/apps/details?id=com.inutrips.driver" target="_blank" rel="noopener noreferrer" className="bg-secondary text-white px-6 py-3 rounded-xl flex items-center gap-3 hover:bg-opacity-90 transition-all shadow-lg hover:-translate-y-1">
                                        {/* Google Play Icon SVG */}
                                        <svg viewBox="0 0 24 24" className="w-6 h-6 fill-current" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M3.609 1.814L13.792 12 3.61 22.186c-.184-.131-.334-.316-.408-.558L3 2.18c.046-.145.247-.366.609-.366zM15.207 13.414l5.658 5.659c.28.278.435.658.435 1.054 0 .394-.154.775-.436 1.053l-5.657-5.658zM4.322 23.368l11.41-11.41 1.487 1.488L5.353 23.58c-.378.214-.816.143-1.03-.143l-.001-.069zM17.219 4.145l-1.487 1.487-11.41-11.41 11.866 10.134a1.493 1.493 0 0 1 1.031-.211z" />
                                        </svg>
                            ...
                            <div className="relative z-10 grid md:grid-cols-2 gap-12 items-center divide-y md:divide-y-0 md:divide-x divide-white/10">
                                ...
                                <div className="text-center md:text-left md:pr-8">
                                    ...
                                    <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
                                        <a href="https://apps.apple.com/co/app/inutrips/id6450268527" target="_blank" rel="noopener noreferrer" className="bg-white text-secondary px-5 py-3 rounded-xl flex items-center gap-3 hover:bg-gray-100 transition-all shadow-lg hover:scale-105 group">
                                            {/* Apple Logo SVG */}
                                            <svg viewBox="0 0 384 512" className="w-5 h-5 fill-current" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M318.7 268.7c-.2-36.7 16.4-64.4 50-84.8-18.8-26.9-47.2-41.7-84.7-44.6-35.5-2.8-74.3 20.7-88.5 20.7-15 0-49.4-19.7-76.4-19.7C63.3 141.2 4 184.8 4 273.5q0 39.3 14.4 81.2c12.8 36.7 59 126.7 107.2 125.2 25.2-.6 43-17.9 75.8-17.9 31.8 0 48.3 17.9 76.4 17.9 48.6-.7 90.4-82.5 102.6-119.3-65.2-30.7-61.7-90-61.7-91.9zm-56.6-164.2c27.3-32.4 24.8-61.9 24-72.5-24.1 1.4-52 16.4-67.9 34.9-17.5 19.8-27.8 44.3-25.6 71.9 26.1 2 52.3-11.4 69.5-34.3z" />
                                            </svg>
                                            <div className="text-left">
                                                <div className="text-[9px] uppercase font-bold tracking-wider text-gray-400 group-hover:text-secondary transition-colors">Consíguelo en el</div>
                                                <div className="font-bold text-sm leading-none font-display">App Store</div>
                                            </div>
                                        </a>
                                        <a href="https://play.google.com/store/apps/details?id=com.inutrips.passenger" target="_blank" rel="noopener noreferrer" className="bg-primary text-secondary px-5 py-3 rounded-xl flex items-center gap-3 hover:bg-yellow-400 transition-all shadow-lg hover:scale-105 border-2 border-primary">
                                            {/* Google Play Icon SVG */}
                                            <svg viewBox="0 0 24 24" className="w-5 h-5 fill-current" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M3.609 1.814L13.792 12 3.61 22.186c-.184-.131-.334-.316-.408-.558L3 2.18c.046-.145.247-.366.609-.366zM15.207 13.414l5.658 5.659c.28.278.435.658.435 1.054 0 .394-.154.775-.436 1.053l-5.657-5.658zM4.322 23.368l11.41-11.41 1.487 1.488L5.353 23.58c-.378.214-.816.143-1.03-.143l-.001-.069zM17.219 4.145l-1.487 1.487-11.41-11.41 11.866 10.134a1.493 1.493 0 0 1 1.031-.211z" />
                                            </svg>
                                            <div className="text-left">
                                                <div className="text-[10px] uppercase font-bold tracking-wider text-secondary/60">Disponible en</div>
                                                <div className="font-bold text-sm leading-none font-display">Google Play</div>
                                            </div>
                                        </a>
                                    </div>
                                </div>
                                ...
                                <div className="text-center md:text-left md:pl-8 pt-8 md:pt-0">
                                    ...
                                    <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
                                        <a href="https://apps.apple.com/co/app/inutrips-drive/id6748416907" target="_blank" rel="noopener noreferrer" className="bg-white text-secondary px-5 py-3 rounded-xl flex items-center gap-3 hover:bg-gray-100 transition-all shadow-lg hover:scale-105 group">
                                            {/* Apple Logo SVG */}
                                            <svg viewBox="0 0 384 512" className="w-5 h-5 fill-current" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M318.7 268.7c-.2-36.7 16.4-64.4 50-84.8-18.8-26.9-47.2-41.7-84.7-44.6-35.5-2.8-74.3 20.7-88.5 20.7-15 0-49.4-19.7-76.4-19.7C63.3 141.2 4 184.8 4 273.5q0 39.3 14.4 81.2c12.8 36.7 59 126.7 107.2 125.2 25.2-.6 43-17.9 75.8-17.9 31.8 0 48.3 17.9 76.4 17.9 48.6-.7 90.4-82.5 102.6-119.3-65.2-30.7-61.7-90-61.7-91.9zm-56.6-164.2c27.3-32.4 24.8-61.9 24-72.5-24.1 1.4-52 16.4-67.9 34.9-17.5 19.8-27.8 44.3-25.6 71.9 26.1 2 52.3-11.4 69.5-34.3z" />
                                            </svg>
                                            <div className="text-left">
                                                <div className="text-[10px] uppercase font-bold tracking-wider text-gray-400 group-hover:text-secondary transition-colors">Consíguelo en el</div>
                                                <div className="font-bold text-sm leading-none font-display">App Store</div>
                                            </div>
                                        </a>
                                        <a href="https://play.google.com/store/apps/details?id=com.inutrips.driver" target="_blank" rel="noopener noreferrer" className="bg-primary text-secondary px-5 py-3 rounded-xl flex items-center gap-3 hover:bg-yellow-400 transition-all shadow-lg hover:scale-105 border-2 border-primary">
                                            {/* Google Play Icon SVG */}
                                            <svg viewBox="0 0 24 24" className="w-5 h-5 fill-current" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M3.609 1.814L13.792 12 3.61 22.186c-.184-.131-.334-.316-.408-.558L3 2.18c.046-.145.247-.366.609-.366zM15.207 13.414l5.658 5.659c.28.278.435.658.435 1.054 0 .394-.154.775-.436 1.053l-5.657-5.658zM4.322 23.368l11.41-11.41 1.487 1.488L5.353 23.58c-.378.214-.816.143-1.03-.143l-.001-.069zM17.219 4.145l-1.487 1.487-11.41-11.41 11.866 10.134a1.493 1.493 0 0 1 1.031-.211z" />
                                            </svg>
