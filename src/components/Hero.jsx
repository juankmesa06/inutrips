    ...
    return (
        <div className="relative min-h-[500px] md:min-h-[600px] flex items-center justify-center overflow-hidden bg-white pt-24 pb-12">
            ...
            <div className="container mx-auto px-4 relative z-10 flex flex-col items-center text-center">
                ...
                {/* Hero Banner Image */}
                <motion.div
                    className="w-full max-w-5xl mb-12 relative p-4 md:p-6 bg-white rounded-[2.5rem] shadow-2xl border border-gray-100"
                ...
                <div className="grid md:grid-cols-2 gap-8 w-full max-w-5xl mx-auto items-stretch">
                    ...
                    >
                        ...
                        <div className="flex flex-wrap justify-center gap-3 md:gap-4">
                            ...
                            <a href="https://play.google.com/store/search?q=inutrips&c=apps" target="_blank" rel="noopener noreferrer" className="bg-black text-white px-4 py-2 rounded-xl flex items-center gap-2 hover:scale-105 transition-transform shadow-lg w-40 justify-center">
                    ...
                    >
                        ...
                        <div className="flex flex-wrap justify-center gap-3 md:gap-4">
                            ...
                            <a href="https://play.google.com/store/apps/details?id=com.inutrips.inuapp" target="_blank" rel="noopener noreferrer" className="bg-[#675544] text-white px-4 py-2 rounded-xl flex items-center gap-2 hover:scale-105 transition-transform shadow-lg w-40 justify-center">
                                {/* Google Play Icon SVG */}
                                <svg viewBox="0 0 24 24" className="w-6 h-6 md:w-7 md:h-7 fill-current" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M3.609 1.814L13.792 12 3.61 22.186c-.184-.131-.334-.316-.408-.558L3 2.18c.046-.145.247-.366.609-.366zM15.207 13.414l5.658 5.659c.28.278.435.658.435 1.054 0 .394-.154.775-.436 1.053l-5.657-5.658zM4.322 23.368l11.41-11.41 1.487 1.488L5.353 23.58c-.378.214-.816.143-1.03-.143l-.001-.069zM17.219 4.145l-1.487 1.487-11.41-11.41 11.866 10.134a1.493 1.493 0 0 1 1.031-.211z" />
                                </svg>
